          ...
          child: Column(
            ...
            children: [
              ...
              Option(desktopicon, label: 'Create desktop icon')
                  .marginOnly(bottom: 7),
              // No remote printer option: the printer driver is not shipped
              // (it only works with RustDesk-signed binaries), so `printer`
              // stays false.
              Container(
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () =>
                                launchUrlString('https://arennalabs.com'),
                            child: Tooltip(
                              message: 'https://arennalabs.com',
                              child: Row(children: [
