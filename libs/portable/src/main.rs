...
// Unpack dir under %LOCALAPPDATA%; must differ from RustDesk's "rustdesk".
const APP_PREFIX: &str = "ArennaRemote";
...
mod win {
    ...
    pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_arennaremote.exe";
